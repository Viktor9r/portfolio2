...
Command: npx gltfjsx@6.2.16 laptop_coswick.gltf 
...
export default function LaptopCoswick(props) {
  const { nodes, materials } = useGLTF('/models/laptop/laptop_coswick.gltf')
  const defaultPosition = [0, -15, -50]; 
  
  return (
    <group rotation={[Math.PI / 6, 0, 0]} position={defaultPosition} {...props} dispose={null}>
      <group scale={1.5}>
        ...
        <mesh geometry={nodes.SadnAkehSlxIwKv.geometry} material={materials.VNZklasZKSWjWUk} />
...
useGLTF.preload('/models/laptop/laptop_coswick.gltf')
